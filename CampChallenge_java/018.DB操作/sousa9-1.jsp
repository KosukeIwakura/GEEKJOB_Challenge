<%-- 
    Document   : sousa9-1
    Created on : 2017/09/06, 14:13:13
    Author     : Fleshgod4618
--%>
    ...
    <body> 
        ...
        <form action="sousa9_2" method="post"> 
            ...
            <center> 
                ...
                名前<br><input type="text" name="name" value="例：岩倉洸介"><br><br> 



                電話番号<br><input type="text" name="tell" size="24" value="例：012-3456-7890（半角）"><br><br> 
